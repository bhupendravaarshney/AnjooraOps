...
try {
  ...
  const { rows } = await client.query(`SELECT id FROM inventory_items WHERE sku IN ('RM-ASHWAGANDHA','RM-BRAHMI','RM-JATAMANSI','PK-INFUSION-POUCH','FG-SLEEP-INF-01','FG-CALM-INF-01')`);
